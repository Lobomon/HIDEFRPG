...
import com.util.battle.LevelTable;
...
public class StatusUI extends Window implements StatusSubject {
    ...
    private TextButton _zoomInButton;
    private TextButton _zoomOutButton;
    ...
    public StatusUI(){
    	...
    	_zoomInButton = new TextButton("+", Utility.STATUSUI_SKIN);
    	_zoomOutButton = new TextButton("-", Utility.STATUSUI_SKIN);
        ...
        this.add(_zoomInButton);
        this.add(_zoomOutButton);
    ...
    public TextButton getZoomInButton() {
        return _zoomInButton;
    }

    public TextButton getZoomOutButton() {
