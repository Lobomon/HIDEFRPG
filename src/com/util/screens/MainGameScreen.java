...
public class MainGameScreen extends GameScreen {
	...
	public MainGameScreen(EngineGameStart game){
		_game = game;
	...
	public void render(float delta) {
		if( _gameState == GameState.GAME_OVER ){
			_game.setScreen(_game.getScreenType(EngineGameStart.ScreenType.GameOver));
		}
		...
		_camera.zoom=_mapMgr.getMapZoom();
