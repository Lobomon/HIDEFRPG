...
import com.main.components.EntityFactory;
import com.main.components.Map;
import com.main.components.MapFactory;
import com.main.components.Utility;
import com.util.UI.AnimatedImage;
import com.util.audio.AudioObserver;
import com.util.battle.MonsterFactory;
...
public class CutSceneScreen extends MainGameScreen {
    ...
    public CutSceneScreen(EngineGameStart game) {
        super(game);
        ...
        _switchScreenAction = new RunnableAction(){
            @Override
            public void run() {
                _game.setScreen(_game.getScreenType(EngineGameStart.ScreenType.MainMenu));
            }
        };
